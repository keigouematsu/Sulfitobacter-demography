...
data_3_1000 = pd.read_table('/home/keigo/tree_compatibility_ms1000.txt',header=None)
data_3_500 = pd.read_table('/home/keigo/tree_compatibility_ms500.txt',header=None)
data_3_2000 = pd.read_table('/home/keigo/tree_compatibility_ms2000.txt',header=None)
data_3_5000 = pd.read_table('/home/keigo/tree_compatibility_ms5000.txt',header=None)
data_3_10000 = pd.read_table('/home/keigo/tree_compatibility_ms10000.txt',header=None)
...
for j in range(5):
    ...
    params, cv = scipy.optimize.curve_fit(monoExp, dtm_100['dist'], dtm_100['tr_comp'],p0)　#curvefitting
    m, t, b = params
    print(params)
...
for i in range(1):
    ...
    plt.scatter(x='dist', y='tr_comp', s=30,color=col,data= dt_100,label=lab,alpha=0.9, marker="o")
